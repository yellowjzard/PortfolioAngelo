...
const MetricCard = ({ value, label, sub, progress, index }) => {
    ...
    return (
        <motion.div
            ...
            style={{ padding: '2.5rem 2rem', borderRadius: '20px', background: hovered ? 'rgba(8,82,87,0.06)' : 'rgba(255,255,255,0.7)', border: `1px solid ${hovered ? 'rgba(8,82,87,0.3)' : 'rgba(255,255,255,0.9)'}`, backdropFilter: 'blur(12px)', cursor: 'default', transition: 'background 0.3s, border 0.3s', position: 'relative', overflow: 'hidden' }}
        >
            {/* glow di sfondo */}
    ...
    return (
        ...
        >
            <motion.div animate={{ rotateY: flipped ? 180 : 0 }} transition={{ duration: 0.6, ease: [0.215, 0.61, 0.355, 1.0] }} style={{ width: '100%', height: '100%', transformStyle: 'preserve-3d', position: 'relative' }}>
                {/* Front */}
                <div style={{ position: 'absolute', inset: 0, backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(12px)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.9)', padding: '2rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', boxShadow: '0 8px 30px rgba(0,0,0,0.05)' }}>
                ...
                {/* Back */}
                <div style={{ position: 'absolute', inset: 0, backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden', transform: 'rotateY(180deg)', background: 'linear-gradient(135deg, #085257, #0d7a82)', borderRadius: '20px', padding: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    <div style={{ position: 'relative', paddingLeft: '24px' }}>
        ...
        {items.map((item, index) => (
            <motion.div key={index} initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.2, type: 'spring', stiffness: 60 }}
                ...
                <motion.div data-hover whileHover={{ x: 6 }} style={{ marginLeft: '22px', background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)', padding: '1.4rem 1.8rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.9)', flex: 1, boxShadow: '0 4px 20px rgba(0,0,0,0.04)', cursor: 'default' }}>
...
const ProblemCard = ({ icon, title, body, index }) => (
    <motion.div data-hover initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.15 }}
        ...
        style={{ padding: '1.8rem 2rem', background: 'rgba(239,68,68,0.04)', borderRadius: '16px', borderLeft: '4px solid #ef4444', cursor: 'default', transition: 'background 0.3s' }}>
        ...
        <div style={{ fontFamily: '"DM Sans", sans-serif', minHeight: '100vh' }}>
            ...
            <div style={{ position: 'relative', zIndex: 10, paddingBottom: '120px' }}>
                ...
                <section style={{ maxWidth: '1000px', margin: '0 auto 50px auto', padding: '4rem 2rem' }}>
                    <Reveal>
                        <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(20px)', borderRadius: '28px', padding: '4rem 3rem', border: '1px solid rgba(255,255,255,0.9)', boxShadow: '0 20px 60px rgba(0,0,0,0.05)' }}>
                ...
                <section style={{ maxWidth: '1000px', margin: '0 auto 50px auto', padding: '0 2rem' }}>
                    <div style={{ background: 'rgba(255,255,255,0.65)', backdropFilter: 'blur(20px)', borderRadius: '28px', padding: '3.5rem', border: '1px solid rgba(255,255,255,0.9)', boxShadow: '0 20px 60px rgba(0,0,0,0.05)' }}>
                        <Reveal>
                ...
                <section style={{ maxWidth: '1000px', margin: '0 auto 50px auto', padding: '0 2rem' }}>
                    <Reveal>
                        <motion.div data-hover whileHover={{ scale: 1.01 }} style={{ background: 'linear-gradient(135deg, #085257 0%, #0d8a94 100%)', borderRadius: '28px', padding: '4rem 3.5rem', position: 'relative', overflow: 'hidden', cursor: 'default' }}>
                            {/* Decorazioni */}
                ...
                {/* FOOTER */}
                <footer style={{ textAlign: 'center', padding: '4rem 2rem 2rem', opacity: 0.5 }}>
