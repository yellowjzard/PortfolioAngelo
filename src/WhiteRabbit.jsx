...
const WR_LANG = {
    ...
    en: {
        ...
        'challenge-t': 'THE CHALLENGE', 'challenge-d': 'The agency required an evolutionary leap in video production for international campaigns. The goal was to overcome traditional rendering constraints while maintaining cinematic quality and precise creative control.',
        'solution-t': 'THE SOLUTION', 'solution-d': 'I developed a proprietary "AI-Augmented" pipeline, integrating Higgsfield (utilizing Nano, Banana Pro, and Veo models) for controlled video generation. Furthermore, I built Gemini Agents to automate scripting and concept development, reducing turnaround from days to hours.',
        'results-t': 'IMPACT & RESULTS', 'res-1': 'Time-to-Market: -60%', 'res-2': 'Hybrid Workflow', 'res-3': 'Autonomous Agents', 'res-4': 'AI Pioneer Status',
        'project-endurance': 'THE ENDURANCE PROJECT', 'project-desc': 'Epic Corporate Storytelling: a tribute to team resilience inspired by the 1914 expedition. Employees become cinematic leads through AI Face Swap integration.',
        'step-1-t': 'AI World Building', 'step-1-d': 'Defining the aesthetic through advanced prompting and generating consistent style-frames for scene setting.',
        'step-2-t': 'Hybrid Editing & Face Swap', 'step-2-d': 'Traditional timeline editing combined with Neural Face Swap. I replaced generated faces with target characters, ensuring Character Consistency across every scene.',
